    ...
    <div class="flex flex-col h-full justify-between items-stretch">
        ...
        <div class="flex flex-col items-center">
            <div class="card lg:card-side bg-base-100 shadow-xl">
                <div class="card-body">
                    <DyTextInput v-model="form_data.name" :label="'Nome'" />
                    <DyTextInput v-model="form_data.email" :label="'Email'" />
                    ...
                    <button
                        ...
                        class="btn btn-active btn-primary btn-xs sm:btn-sm md:btn-md lg:btn-lg"
                    >
                        Cadastre-se
                    </button>
                </div>
