    ...
    <div class="navbar bg-base-content/80 min-h-0 p-0">
        ...
        <div class="navbar-center flex">
            <div role="tablist" class="tabs tabs-lifted tabs-lg">
                <DaisyNuxtLink :href="'/'"> Lista </DaisyNuxtLink>
                <DaisyNuxtLink :href="'/feed'"> Posts </DaisyNuxtLink>
                ...
                <template v-else>
                    ...
                    <DaisyNuxtLink :href="'/login'"> Login </DaisyNuxtLink>
                </template>
            </div>
        </div>
        <div class="navbar-end">
            <section
                role="tablist"
                class="tabs tabs-lifted tabs-lg rotate-180 scale-125"
                v-if="user?.name"
            >
                <div class="tab tab-active text-base-content/80">
                    <section class="text-xs rotate-180">
                        <div class="dropdown dropdown-end">
                            ...
                            <ul
                                tabindex="0"
                                class="menu dropdown-content z-[1] text-xs shadow bg-base-100 rounded-box w-16 mt-1"
                            >
