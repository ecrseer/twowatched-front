<template>
  <div class="relative float-label-input">
    <input
      ...
      class="w-full focus:outline-none focus:shadow-outline border border-gray-300 rounded-md py-3 px-3 block appearance-none leading-normal focus:border-fuchsia-400"
    />
